...
import {RandcastSystem} from "../RandcastModule/RandcastSys.sol";
import {SystemSwitch} from "@latticexyz/world-modules/src/utils/SystemSwitch.sol";
import {SYSTEM_ID, TABLE_ID} from "../RandcastModule/constants.sol";
import {IWorld} from "../codegen/world/IWorld.sol";
import {Randcast} from "../RandcastModule/tables/Randcast.sol";
...
function getLastSubscription(address consumer) returns (uint64) {
    return abi.decode(
        SystemSwitch.call(SYSTEM_ID, abi.encodeCall(RandcastSystem.getLastSubscription, (consumer))), (uint64)
    );
}
