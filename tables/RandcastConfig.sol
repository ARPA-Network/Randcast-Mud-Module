...
FieldLayout constant _fieldLayout = FieldLayout.wrap(0x0028020014140000000000000000000000000000000000000000000000000000);
...
library RandcastConfig {
     ...
     */
    function getConsumerWrapperAddress(ResourceId _tableId, bytes32 key)
        internal
        view
        returns (address consumerWrapperAddress)
    {
     ...
     * @notice Get consumerWrapperAddress.
     */
    function _getConsumerWrapperAddress(ResourceId _tableId, bytes32 key)
        internal
        view
        returns (address consumerWrapperAddress)
    {
     ...
     */
    function set(ResourceId _tableId, bytes32 key, address consumerWrapperAddress, address adapterAddress) internal {
        bytes memory _staticData = encodeStatic(consumerWrapperAddress, adapterAddress);
     ...
     * @notice Set the full data using individual values.
     */
    function _set(ResourceId _tableId, bytes32 key, address consumerWrapperAddress, address adapterAddress) internal {
        bytes memory _staticData = encodeStatic(consumerWrapperAddress, adapterAddress);
    ...
    function set(ResourceId _tableId, bytes32 key, RandcastConfigData memory _table) internal {
        bytes memory _staticData = encodeStatic(_table.consumerWrapperAddress, _table.adapterAddress);
    ...
    function decodeStatic(bytes memory _blob)
        internal
        pure
        returns (address consumerWrapperAddress, address adapterAddress)
    {
    ...
    function decode(bytes memory _staticData, PackedCounter, bytes memory)
        internal
        pure
        returns (RandcastConfigData memory _table)
    {
        (_table.consumerWrapperAddress, _table.adapterAddress) = decodeStatic(_staticData);
    }
     ...
     */
    function encodeStatic(address consumerWrapperAddress, address adapterAddress)
        internal
        pure
        returns (bytes memory)
    {
        return abi.encodePacked(consumerWrapperAddress, adapterAddress);
    }
     ...
     */
    function encode(address consumerWrapperAddress, address adapterAddress)
        internal
        pure
